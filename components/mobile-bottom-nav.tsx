...
export function MobileBottomNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50">
      {/* Background extension for Safari mobile */}
      <div className="absolute inset-x-0 bottom-0 h-[200px] bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm -z-10" />

      <nav className="relative bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm border-t pb-[env(safe-area-inset-bottom)]">
